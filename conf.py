...
comments_config = {'utterances': {'repo': 'samukweku/data-wrangling-blog', 'optional': 'config'}}
copyright = '2021'
...
html_theme_options = {'search_bar_text': 'Search this book...', 'launch_buttons': {'notebook_interface': 'classic', 'binderhub_url': '', 'jupyterhub_url': '', 'thebe': False, 'colab_url': ''}, 'path_to_docs': 'notebooks', 'repository_url': 'https://github.com/samukweku/data-wrangling-blog', 'repository_branch': 'master', 'extra_footer': '', 'home_page_in_toc': True, 'announcement': '', 'analytics': {'google_analytics_id': ''}, 'use_repository_button': True, 'use_edit_page_button': False, 'use_issues_button': True}
html_title = 'Data Wrangling and Automation'
